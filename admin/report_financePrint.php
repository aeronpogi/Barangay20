    ...
    <div style="margin: 50px 0">
        <a a href="javascript:Clickheretoprint()" class="btn btn-success btn-sm"><span><i class="fa fa-print" aria-hidden="true"></i> Print</span></a>
                    ...
                    <center>
                     <div class="header">
                    <div class="box logo">
                        <img src="img/Barangay.svg" alt="" width="100" style="float: left; margin-left: 35px"> 
                    </div>
                    ...
                    <h2 class="title" style="margin-right: 65px">Finance Report</h2>
                </div>
                </center>
                <br>
                    <table id="" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <th width="23%" style="text-align: left;">Requestor</th>
                        <th width="19%" style="text-align: left;">Date</th>
                        <th width="18%" style="text-align: left;">Fee</th>
                      </tr>
                      </thead>
                      <tbody>
                      <?php
                      ...
                      $to = $_GET['to'];
                          # code...
                          $query = mysqli_query($conn, "SELECT * from application where pickupMode='Delivery' and udate_approve BETWEEN '$from' AND '$to'; ") or die(mysqli_error($conn));
