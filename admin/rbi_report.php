                ...
                <form action="" method="get">
                    <div class="row">
                        <div class="form-group col-sm-3">
                            ...
                            <input type="date" name="from" class="form-control" style="font-size: 14px">
                        </div>
                        <div class="form-group col-sm-3">
                            <label style="">TO:</label> <span style="color:red;">*</span> 
                            <input type="date" name="to" class="form-control" style="font-size: 14px">
                        </div>
                        ...
                        <div style="float: right">  
                            ...
                            <a href="rbiReportExport.php"  class="btn btn-success btn-sm"><span><i class="fa fa-download" aria-hidden="true"></i> Export</span></a>
            ...
            <br>
                <table id="" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th width="15%" style="text-align: left;">Birthday</th>
                  ...
                  $to = $_GET['to'];
                      ...
                      //   $query = mysqli_query($conn, "SELECT * from rbi_tenant ") or die(mysqli_error($conn));
                        $query = mysqli_query($conn, "SELECT * from rbi_tenant where dateAdded BETWEEN '$from' and '$to';") or die(mysqli_error($conn));
