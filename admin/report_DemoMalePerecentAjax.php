<?php
 ...
 if (isset($_POST['filterMatch'])){
        ...
        if($filterMatch == "Single") {
            ...
            // $query3 = mysqli_query($conn,"SELECT id FROM rbi_tenant WHERE  status='Active'");
            // $row3 = mysqli_num_rows($query3);
            // $percent = $row2 / $row3 * 100;
            // echo $percent.'% of the total residents';
        }
        ...
        elseif($filterMatch == "Non-voters") {
            ...
            $query2 = mysqli_query($conn,"SELECT id FROM rbi_tenant WHERE voter_status='Not-Registered' and status='Active' ");
            $row2 = mysqli_num_rows($query2);
            echo $row2;
        }
        ...
        elseif($filterMatch == "Adult") {
            ...
            $query2 = mysqli_query($conn,"SELECT id FROM rbi_tenant WHERE age >17 and age <58  and status='Active' ");
            $row2 = mysqli_num_rows($query2);
            echo $row2;
        }
        ...
        elseif($filterMatch == "Employed") {
            ...
            $query2 = mysqli_query($conn,"SELECT id FROM rbi_tenant WHERE  occupation !='N/A' and status='Active' ");
            $row2 = mysqli_num_rows($query2);
            echo $row2;
        }
