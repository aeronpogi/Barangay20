          ...
          function sendEmail() {
              ...
              $.ajax({
                ...
                data: {
                    ...
                    email: email.val(),
                    // body: body.val()
                    body: "Hi! <br><br> We want to you inform you that your Barangay Clearance request has been denied. Please proceed to Barangay Hall to discuss your problem.<br><br> Thank you! <br><br>Regards, <br> <b>BRGY Dinalupihan</b>"
