...
<body>
    ...
    <div style="margin: 50px 0">
        <a a href="javascript:Clickheretoprint()" class="btn btn-success btn-sm"><span><i class="fa fa-print" aria-hidden="true"></i> Print</span></a>
                    ...
                    <br>
                    <h2 class="title" style="margin-right: 65px">INCIDENT REPORT</h2>
                </div>
                </center>
                <br>
                    <table id="" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <th width="23%" style="text-align: left;">Date</th>
                        <th width="19%" style="text-align: left;">Case Nature</th>
                        <th width="18%" style="text-align: left;">Complainant Name</th>
                      </tr>
                      </thead>
                      <tbody>
                      <?php
