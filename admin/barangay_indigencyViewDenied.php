...
include 'include/session.php';
    ...
    if(isset($_POST["approved"])) {
        ...
        if($pick == "Delivery"){
            ...
            $activityLogsql = mysqli_query($conn, "INSERT INTO activityLog (name, position, action, dates)Values ('$username', '$position', 'Approved $usersFullname Indigency request', '$date_approve')") or die(mysqli_error($conn));
        ...
        $update = mysqli_query($conn,"update application set udate_approve ='$date_approve', ustatus ='$req_status'  where id ='$id'") or die (mysqli_error($conn));
        $activityLogsql = mysqli_query($conn, "INSERT INTO activityLog (name, position, action, dates)Values ('$username', '$position', 'Denied $usersFullname Indigency request', '$date_approve')") or die(mysqli_error($conn));
