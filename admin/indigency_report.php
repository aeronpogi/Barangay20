          ...
          <div class="col-12">
               ...
               <div class="card-header" style="display: flex; flex-direction: column; justify-content: center">
                  ...
                  <div class="form-group col-sm-3" style="top:36px">
                    ...
                    <?php
                           ...
                           $d2 = $_GET['d2'];
                    ?>
                      <a href="indigency_reportExport.php?d1=<?php echo $d1;?>&d2=<?php echo$d2;?>"  class="btn btn-success btn-sm"><span><i class="fa fa-download" aria-hidden="true"></i> Export</span></a>
            ...
            <br>
                <table id="" class="table table-bordered table-striped">
                  ...
                  // $d2 = $_GET['d2'];
                      # code...
                      $query = mysqli_query($conn, "SELECT * from application where permit_type = 'Indigency' and udate_approve BETWEEN '$d1' AND '$d2';") or die(mysqli_error($conn));
