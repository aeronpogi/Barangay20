...
<body>
    ...
    <div style="margin: 50px 0">
        <a a href="javascript:Clickheretoprint()" class="btn btn-success btn-sm"><span><i class="fa fa-print" aria-hidden="true"></i> Print</span></a>
                    ...
                    <h2 class="title" style="margin-right: 65px">Certificate of Indigency</h2>
                </div>
                </center>
                <br>
                    <table id="" class="table table-bordered table-striped">
                      ...
                      $to = $_GET['to'];
                          # code...
                          $query = mysqli_query($conn, "SELECT * from application where permit_type='Indigency' and udate_approve BETWEEN '$from' AND '$to'; ") or die(mysqli_error($conn));
